...
class DBData
{
    ...
    if ($exec==1){
        ...
        public function getModifP($name, $description, $picture, $price, $product_id)
        ...
        
        {
            ...
            // if(!empty($_POST)){
            //     if(isset($_POST['news-name'], $_POST['news-description'],$_POST['news-picture'], $_POST['news-price']) && !empty($_POST['news-name']) && !empty($_POST['news-description'])
            //     && !empty($_POST['news-picture'])  && !empty($_POST['news-price']) ){
            ...
            //         $modifP = $query->fetchAll(PDO::FETCH_ASSOC);
        
            //         foreach ($modifP as $product) {
                    
            //             $modifPobjet[] = new product($product['id'],$product['name'],$product['description'],$product['picture'],$product['price']);
