    ...
    <div class="row">
        ...
        <div class="col-md-5 border-right">
            <div class="p-3 py-5">
                ...
                <div class="row mt-2">
                    <div class="col-md-6"><label class="labels">Nom</label><input type="text" class="form-control" placeholder="Nom"  name="new-nom" value=""></div>
            ...
            <input class="btn-danger profile-button rounded" formaction="profil?userId=<?= $_SESSION['login']->getId() ?>" 
